  ...
  return (
    <div className="box-border flex flex-col p-5 desktop:p-[40px] gap-[40px] desktop:gap-[100px] bg-[#E2E9F6] border border-[rgba(128,128,128,0.55)] rounded-[30px]">
      <div className="flex flex-row flex-wrap gap-[10px]">
        ...
        <Badge icon={<FolderIcon />} text="Nr PWZ: 156 36 12" />
      </div>
      <div className="flex flex-col gap-[10px]">
        <p className="text-[length:var(--fs-h2)] leading-[150%] font-bold">O mnie</p>
        <p className="text-[length:var(--fs-h3)] leading-[34px]">
          Absolwentka Wydziału Stomatologii Uniwersytetu Medycznego im. Piastów
          Śląskich we Wrocławiu. Doświadczenie zdobywałam w placówkach w Polsce i
          Wielkiej Brytanii.
        </p>
        <p className="text-[length:var(--fs-h3)] leading-[34px] mt-[length:var(--fs-h3)]">
          Regularnie poszerzam swoje kwalifikacje, biorąc udział w kursach i
          konferencjach. Mam wieloletnie doświadczenie w pracy z dziećmi oraz w
          leczeniu osób z niepełnosprawnościami.
        </p>
      </div>
    </div>
  );
